...
# function to receive the extracted IP and print it as table 
...
# function to receive the port number of the scanned IP and print it as table
...
# # function to receive the extracted Domains and print it as table
...
# function to receive the extracted URLs and print it as table
def url_information():
    all_url = extract_url()
...
# function to receive the passive DNS information and print it as table
...
# function to receive the whois information and print it as table
